package com.epsilonmusic.app.epsilonmusiccanvas

import com.epsilonmusic.app.canvas.CanvasArtwork
...
@Serializable
data class epsilonmusicCanvasManifest(
    val items: List<epsilonmusicCanvasItem> = emptyList()
)

@Serializable
data class epsilonmusicCanvasItem(
    val song: String,
    val artist: String,
    val url: String
)
...
object epsilonmusicCanvasProvider {
    ...
    private data class CacheEntry(
        val value: epsilonmusicCanvasManifest?,
    ...
    private suspend fun fetchManifest(): epsilonmusicCanvasManifest? {
        ...
        return try {
            val manifest: epsilonmusicCanvasManifest = client.get(BASE_URL).body()

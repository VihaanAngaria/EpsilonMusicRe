                ...
                Row(
                    ...
                    Row(
                        ...
                        Switch(
                            ...
                            onCheckedChange = {
                                // Avoid calling context.isSyncEnabled() synchronously here —
                                // it uses runBlocking which would freeze the UI thread for
                                // 50–500 ms on a cold datastore read. Dispatch to IO instead.

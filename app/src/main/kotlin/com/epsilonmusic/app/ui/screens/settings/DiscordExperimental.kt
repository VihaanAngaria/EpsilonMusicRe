...
import com.epsilonmusic.app.constants.DiscordActivityButton1CustomUrlKey
import com.epsilonmusic.app.constants.DiscordActivityButton1EnabledKey
import com.epsilonmusic.app.constants.DiscordActivityButton1LabelKey
import com.epsilonmusic.app.constants.DiscordActivityButton1UrlSourceKey
import com.epsilonmusic.app.constants.DiscordActivityButton2CustomUrlKey
import com.epsilonmusic.app.constants.DiscordActivityButton2EnabledKey
import com.epsilonmusic.app.constants.DiscordActivityButton2LabelKey
import com.epsilonmusic.app.constants.DiscordActivityButton2UrlSourceKey
import com.epsilonmusic.app.ui.component.EditTextPreference
import com.epsilonmusic.app.ui.component.ListPreference
...
fun DiscordExperimental(navController: NavController) {
    ...
    val (button2Label, onButton2LabelChange) =
        rememberPreference(
            ...
            defaultValue = "Go to Epsilon Music",
        )
    ...
    val (button2CustomUrl, onButton2CustomUrlChange) =
        rememberPreference(
            ...
            defaultValue = "https://epsilonmusic.ct.ws",
        )

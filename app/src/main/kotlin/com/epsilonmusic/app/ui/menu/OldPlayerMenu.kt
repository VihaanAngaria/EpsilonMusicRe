...
import com.epsilonmusic.app.extensions.toggleRepeatMode
import com.epsilonmusic.app.listentogether.RoomRole
...
import com.epsilonmusic.app.ui.component.BottomSheetState
...
import com.epsilonmusic.app.ui.component.VolumeSlider
                ...
                items = buildList {
                    add(
                        Material3MenuItemData(
                            customComposable = {
                                com.epsilonmusic.app.ui.component.CastButton(asMenuItem = true)
                            }
                        )
                    )
                    ...
                    add(
                        Material3MenuItemData(
                            ...
                            onClick = {
                                ...
                                androidx.media3.exoplayer.offline.DownloadService.sendRemoveDownload(context, com.epsilonmusic.app.playback.ExoDownloadService::class.java, mediaMetadata.id, false)

...
package com.epsilonmusic.app.listentogether
...
import com.epsilonmusic.app.constants.ListenTogetherAutoApprovalKey
import com.epsilonmusic.app.constants.ListenTogetherIsHostKey
import com.epsilonmusic.app.constants.ListenTogetherRoomCodeKey
import com.epsilonmusic.app.constants.ListenTogetherServerUrlKey
import com.epsilonmusic.app.constants.ListenTogetherSessionTimestampKey
import com.epsilonmusic.app.constants.ListenTogetherSessionTokenKey
import com.epsilonmusic.app.constants.ListenTogetherUserIdKey
...
class ListenTogetherClient @Inject constructor(
    ...
    companion object {
        ...
        const val ACTION_APPROVE_JOIN = "com.epsilonmusic.app.LISTEN_TOGETHER_APPROVE_JOIN"
        const val ACTION_REJECT_JOIN = "com.epsilonmusic.app.LISTEN_TOGETHER_REJECT_JOIN"
        const val ACTION_APPROVE_SUGGESTION = "com.epsilonmusic.app.LISTEN_TOGETHER_APPROVE_SUGGESTION"
        const val ACTION_REJECT_SUGGESTION = "com.epsilonmusic.app.LISTEN_TOGETHER_REJECT_SUGGESTION"
    ...
    private fun loadBlockedUsernames() {
        try {
            val blockedJson = context.dataStore.get(com.epsilonmusic.app.constants.ListenTogetherBlockedUsersKey, "")
    ...
    private suspend fun saveBlockedUsernames() {
        try {
            ...
            context.dataStore.edit { preferences ->
                preferences[com.epsilonmusic.app.constants.ListenTogetherBlockedUsersKey] = blockedJson
            }
        } catch (e: Exception) {

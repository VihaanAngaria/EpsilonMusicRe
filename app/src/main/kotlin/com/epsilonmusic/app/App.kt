...
import com.epsilonmusic.app.di.ApplicationScope
import com.epsilonmusic.app.extensions.toEnum
import com.epsilonmusic.app.extensions.toInetSocketAddress
import com.epsilonmusic.app.utils.CrashHandler
import com.epsilonmusic.app.utils.AppContextHolder
...
class App : Application(), SingletonImageLoader.Factory {
    ...
    private suspend fun initializeSettings() {
        ...
        val engineName = settings[com.epsilonmusic.app.constants.PlaybackEngineKey]
        com.epsilonmusic.app.utils.YTPlayerUtils.playbackEngine = try {
            if (engineName != null) com.epsilonmusic.app.constants.PlaybackEngine.valueOf(engineName)
            else com.epsilonmusic.app.constants.PlaybackEngine.AUTO
        } catch (_: Exception) { com.epsilonmusic.app.constants.PlaybackEngine.AUTO }
    ...
    private fun observeSettingsChanges() {
        ...
        com.epsilonmusic.app.utils.lastfm.LastFM.initialize(
